...
const RegisterPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    if (role === "vendor") {
      payload.storeName = form.get("storeName");
    }

    await register(createRegisterDto(payload));
  ...
  return (
    <main className="auth-page">
      <section className="auth-visual register">
        ...
        <p>
          Vendor storefronts, customer carts, simulated escrow, and OTP delivery
          verification are ready for the MERN backend.
        </p>
      </section>
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          ...
          {role === "vendor" && (
            <label>
              ...
              <span>
                <Store size={18} />
                <input name="storeName" required placeholder="Your shop name" />
              </span>
            </label>
          )}
          <label>
          ...
          <button className="btn btn-dark wide" type="submit">
