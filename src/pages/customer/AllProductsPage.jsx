...
const AllProductsPage = () => {
  ...
  return (
    <section className="container-shell catalog-page">
      <Breadcrumbs
        items={[{ label: "Home", path: routes.home }, { label: "Products" }]}
      />
      <div className="catalog-layout">
        <aside className="filter-panel">
          ...
          <label className="toggle-line">
            <input
              ...
              checked={onSale}
              onChange={(event) =>
                setParam("onSale", event.target.checked ? "true" : "")
              }
            />
            On sale only
          </label>
        ...
        <div>
          ...
          {!loading && !error && visibleProducts.length === 0 && (
            <p className="muted-line">No products match those filters.</p>
          )}
          <Pagination
            currentPage={page}
