    ...
    <section className="container-shell checkout-page">
      ...
      <div className="checkout-grid">
        <form className="form-panel" onSubmit={handleSubmit}>
          ...
          <label>
            City
            <input name="city" required placeholder="Kathmandu" />
          </label>
          <label>
            Area
            <input name="area" required placeholder="Sitapaila" />
          </label>
          <div className="escrow-note">
            <ShieldCheck size={22} />
            <span>
              Payment is held in escrow and released only after OTP delivery
              confirmation.
            </span>
          </div>
          <button
        ...
        <aside className="summary-card">
          ...
          <dl>
            ...
            <div>
              <dt>Subtotal</dt>
              <dd>{currency(summary.subtotal)}</dd>
            </div>
            <div>
              <dt>Discount</dt>
              <dd className="danger">-{currency(summary.discount)}</dd>
            </div>
            <div className="total">
              <dt>Escrow Hold</dt>
